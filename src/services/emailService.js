 ...
 */
export async function sendEmail({ to, subject, html, text, replyTo, headers, bcc, attachment }, logger) {
  ...
  if (isBrevoApiEnabled()) {
    return sendViaBrevoApi({ to, subject, html, text, replyTo, bcc, attachment }, logger);
  }
