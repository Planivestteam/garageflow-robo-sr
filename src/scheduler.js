...
export function startScheduler() {
  ...
  schedule(config.cron.reengagement, 'reengagement', () => runAgentWithSupervision('reengagement'));
  schedule(config.cron.smsOutreach, 'sms-outreach', () => runAgentWithSupervision('sms-outreach'));
  schedule(config.cron.deduplication, 'deduplication', () => runAgentWithSupervision('deduplication'));
